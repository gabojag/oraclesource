...
-- 각 부서별 평균 연봉보다 더 받는 도일 부서 근무사원들의 
...
-- LAST_NAME 이 KING 인 사원을 매니저로 두고 있는 모든 사원들의 LAST_NAME, SALARY조회
...
--SELECT COUNT(EMPLOYEE_ID) FROM EMPLOYEES WHERE TO_CHAR(HIRE_DATE, 'YYYY') = '13';
